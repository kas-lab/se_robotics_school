...
**Bio. Francisco Martin Rico** is Full Professor at Rey Juan Carlos University (Madrid, Spain), where he leads the Intelligent Robotics Lab.
His research and teaching focus on software architectures for robots, planning, cognitive systems, mobile robot navigation, and ROS 2 technologies.

He is the author of the book A Concise Introduction to Robot Programming with ROS 2 and is widely recognized for his contributions to the ROS 2 ecosystem.
Francisco is the main author of PlanSys2, the reference symbolic planning framework for ROS 2, and has contributed to several core ROS 2 packages, including rclcpp, Behavior Trees, and Nav2.
He has also served as a member of the ROS 2 Technical Steering Committee and is currently President of the ROS España Association.

Francisco is actively involved in multiple European and national research projects, and his group is internationally recognized for its work in ROS 2, robot navigation, and automated planning.
In recognition of his impact on the ROS community, he received the ROS Developer of the Year Award at ROS Developer Day 2022.
